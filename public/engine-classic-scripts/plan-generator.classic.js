 ...
 */
function injecterJalonsTransition(semaines) {
  const piocher = (cle) => {
 ...
 */
function injecterNotesPratiques(semaines) {
  const piocher = (cle) => {
 ...
 */
function injecterRepereRessenti(semaines) {
  const piocher = (cle) => {
 ...
 */
function injecterProgressionRelative(semaines) {
 ...
 */
function injecterCoherenceSemaineTest(plan) {
  const piocher = (cle) => {
 ...
 * ignorés).
 */
function injecterApprocheCourse(plan) {
  const piocher = (cle) => {
...
// .calculerRunnerState() (decision-engine-runner-state.classic.js), utilisées
// via les helpers obtenirRatioACWRActuel()/obtenirHistoriqueACWR() de index.html.
 ...
 */
function regenererStructuresIntervalles(plan) {
  if (!plan.paramsOrigine || !plan.profilOrigine) {
