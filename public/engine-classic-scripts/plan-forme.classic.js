...
function computeAlluresForme({ refTimeSeconds, refDistanceKm }) {
...
const ROTATION_SOUS_TYPE_FORME = {
 ...
 */
function genererContenuQualiteForme({ accent, indexRotation, alluresSec, semaineDansCycle = 0 }) {
...
function computeVolumeFormeSemaine({ volumeDepart, semaineNum }) {
