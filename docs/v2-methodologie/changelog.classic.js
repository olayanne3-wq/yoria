...
const VERSIONS = [
      { ver:"v2.38", title:"Écran de chargement personnalisé, fin des clignotements au démarrage, corrections de fiabilité", current:true, notes:[
        "🎨 Le logo Yoria s'affiche désormais pendant tout le chargement de l'app, à la place d'un écran blanc",
        "✨ Plus de clignotements à l'ouverture de l'app — chargement bien plus fluide",
        "📊 Les graphiques de charge d'entraînement (ACWR et monotonie) affichent maintenant leurs dates/semaines en abscisse",
        "🔄 Une séance échangée avec une autre s'affiche maintenant correctement partout, y compris dans la grille de la semaine",
        "🎯 Correctif de cohérence entre le badge \"km cumulés\" et le résumé de préparation, avec un nouveau bouton de recalcul manuel en cas d'écart (Réglages)",
      ]},
